...
export default function BirdGuardActionSection() {
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 lg:text-4xl">
              Schedule Bird Guard Installation
            </h2>
            <p className="mb-8 text-lg leading-relaxed text-slate-700">
              Protect your dryer vent from birds and blockages with professional bird guard installation.
            </p>
