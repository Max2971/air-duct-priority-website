...
export default function AirDuctSanitizingHero() {
  return (
    <section className="relative h-[75vh] w-full overflow-hidden mb-2">
      <div className="absolute inset-0 z-0">
        <img
          className="h-full w-full object-cover"
          src="/air-duct-sanitizing.webp"
          alt="Air duct sanitizing service"
        />
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h1 className="mb-6 text-3xl md:text-5xl font-bold leading-tight text-white lg:text-6xl">
              Professional Air Duct Sanitizing in Bucks County, PA
            </h1>
            ...
            <p className="mt-6 text-sm text-white/70">
              Professional Air Duct Sanitizing
            </p>
