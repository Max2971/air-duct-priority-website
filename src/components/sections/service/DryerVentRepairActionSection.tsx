...
export default function DryerVentRepairActionSection() {
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 lg:text-4xl">
              Schedule Dryer Vent Repair Service
            </h2>
            <p className="mb-8 text-lg leading-relaxed text-slate-700">
              Get professional dryer vent repair and restore safe, proper airflow in your home.
            </p>
