...
export default function AirDuctConstructionCleaningHero() {
  return (
    <section className="relative h-[75vh] w-full overflow-hidden mb-2">
      <div className="absolute inset-0 z-0">
        <img
          className="h-full w-full object-cover"
          src="/air-duct-constraction.webp"
          alt="Air duct construction cleaning service"
        />
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h1 className="mb-6 text-3xl md:text-5xl font-bold leading-tight text-white lg:text-6xl">
              Professional Air Duct Construction Cleaning in Bucks County, PA
            </h1>

            <p className="mb-12 md:mb-8 text-lg md:text-xl text-white/90 lg:text-2xl">
              Specialized post-construction air duct cleaning to remove debris, drywall dust, and construction materials from your HVAC system.
            </p>
            ...
            <div className="mt-8 md:mt-0">
              ...
              >
                ...
                Free Home Air Quality Check
              </a>
            </div>

            <p className="mt-6 text-sm text-white/70">
              Professional Air Duct Construction Cleaning
            </p>
