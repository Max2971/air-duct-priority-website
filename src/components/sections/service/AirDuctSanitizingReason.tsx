...
export default function AirDuctSanitizingReason() {
  const cards = [
    {
    ...
    },
    {
      ...
      hiddenCause: 'Hidden Cause: Organic matter and microbial growth in ducts produce odors that return even after cleaning. Result: Uncomfortable living space and poor air quality.',
      result: '',
      isPrimary: false
    }
  ];
