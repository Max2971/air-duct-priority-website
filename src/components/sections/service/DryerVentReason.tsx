...
export default function DryerVentReason() {
  const cards = [
    {
      problem: 'Clothes Take Too Long to Dry',
      hiddenCause: 'Hidden Cause: Lint builds up inside the dryer vent line over time, especially in long runs and elbows where airflow slows down. Result: Longer drying times, higher energy usage, and unnecessary strain on the dryer.',
      result: '',
      isPrimary: false
    },
    {
      problem: 'Dryer Overheats or Shuts Off',
      hiddenCause: 'Hidden Cause: Restricted airflow prevents heat from exiting the system properly, causing internal temperature buildup. Result: Increased fire risk and potential damage to heating elements and internal components.',
      result: '',
      isPrimary: false
    },
    {
      problem: 'Burning Smell or Excessive Lint Around the Dryer',
      hiddenCause: 'Hidden Cause: Lint accumulation inside the vent becomes highly flammable when exposed to sustained heat. Result: Serious fire hazard and unsafe operating conditions inside the home.',
      result: '',
      isPrimary: false
    }
  ];
      ...
      <div className="container mx-auto max-w-5xl px-6">
        ...
        <div className="mb-12 text-center">
          <h2 className="mb-3 text-2xl font-bold lg:text-3xl">
            Why Dryer Vent Problems Happen
          </h2>
          <p className="mx-auto max-w-2xl text-base text-slate-600">
            Most dryer vent issues develop gradually and remain unnoticed until airflow becomes restricted or safety risks appear.
          </p>
        </div>
