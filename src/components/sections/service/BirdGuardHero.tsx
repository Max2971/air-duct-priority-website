...
export default function BirdGuardHero() {
  return (
    <section className="relative h-[75vh] w-full overflow-hidden mb-2">
      <div className="absolute inset-0 z-0">
        <img
          className="h-full w-full object-cover"
          src="/hero-bird-guard.webp"
          alt="Bird guard installation service"
        />
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h1 className="mb-6 text-3xl md:text-5xl font-bold leading-tight text-white lg:text-6xl">
              Professional Dryer Vent Bird Guard Installation in Bucks County, PA
            </h1>

            <p className="mb-12 md:mb-8 text-lg md:text-xl text-white/90 lg:text-2xl">
              Professional bird guard installation to prevent birds, nests, and debris from blocking your dryer vent and creating fire hazards.
            </p>
