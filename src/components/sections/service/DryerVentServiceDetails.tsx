  ...
  return (
    <>
      ...
      <section className="bg-slate-900 py-20 lg:py-24"><div className="container mx-auto max-w-6xl px-6"><div className="grid gap-10 lg:grid-cols-2 lg:items-start">
        <div><p className="mb-3 text-sm font-bold uppercase tracking-widest text-[#F97316]">Clear Recommendation</p><h2 className="mb-5 text-3xl font-bold !text-white lg:text-4xl">{approachHeading}</h2><p className="mb-6 text-slate-300">Air Duct Priority explains what is found and recommends the practical dryer vent option without pressure.</p><Link to="/services/dryer-vent-cleaning" className="font-semibold text-blue-400 underline hover:text-blue-300">Learn about dryer vent cleaning</Link></div>
