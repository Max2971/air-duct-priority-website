...
export default function AirDuctConstructionCleaningActionSection() {
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 lg:text-4xl">
              Schedule Air Duct Construction Cleaning Service
            </h2>
            <p className="mb-8 text-lg leading-relaxed text-slate-700">
              Request professional post-construction air duct cleaning and an air quality check for your home in Bucks County.
            </p>
