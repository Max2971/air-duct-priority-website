...
export default function AirDuctSanitizingActionSection() {
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 lg:text-4xl">
              Schedule Air Duct Sanitizing Service
            </h2>
            <p className="mb-8 text-lg leading-relaxed text-slate-700">
              Request professional air duct sanitizing and an air quality check for your home in Bucks County.
            </p>
