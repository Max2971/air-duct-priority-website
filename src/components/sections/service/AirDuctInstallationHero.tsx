...
export default function AirDuctInstallationHero() {
  return (
    <section className="relative h-[75vh] w-full overflow-hidden mb-2">
      <div className="absolute inset-0 z-0">
        <img
          className="h-full w-full object-cover"
          src="/air-duct-installation.webp"
          alt="Air duct installation service"
        />
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h1 className="mb-6 text-3xl md:text-5xl font-bold leading-tight text-white lg:text-6xl">
              Professional Air Duct Installation in Bucks County, PA
            </h1>

            <p className="mb-12 md:mb-8 text-lg md:text-xl text-white/90 lg:text-2xl">
              Expert air duct installation to ensure proper airflow, system efficiency, and optimal indoor air quality throughout your home.
            </p>
