...
export default function AirDuctInstallationActionSection() {
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="mb-6 text-3xl font-bold text-slate-900 lg:text-4xl">
              Schedule Air Duct Installation Service
            </h2>
            <p className="mb-8 text-lg leading-relaxed text-slate-700">
              Request professional air duct installation and a home assessment for your property in Bucks County.
            </p>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              >
                {isSubmitting ? 'Submitting...' : (
                  <>
                    <span className="md:hidden">Free Home Assessment</span>
                    <span className="hidden md:inline">Free Home Assessment</span>
                  </>
                )}
              </button>
            </form>
