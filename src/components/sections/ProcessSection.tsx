...
export default function ProcessSection({ steps, headline = 'Our Professional Process', description = 'Every service follows our proven 4-step process to ensure your dryer vent system is safe and efficient' }: ProcessSectionProps) {
