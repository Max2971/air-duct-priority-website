      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-8">
            {/* Review Card 1 */}
            <div onMouseEnter={() => handleMouseEnter(0)} className="group relative h-36 cursor-pointer md:h-44 overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:h-auto md:p-8">
              {/* Google Badge */}
              ...
              {/* Front - Default State */}
              <div className="flex flex-col items-center text-center transition-opacity duration-300 md:group-hover:opacity-0">
              ...
              {/* Back - Hover State */}
              <div ref={(el) => (scrollRefs.current[0] = el)} className="absolute inset-0 overflow-y-auto bg-white p-4 opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:p-8">
            ...
            {/* Review Card 2 */}
            <div onMouseEnter={() => handleMouseEnter(1)} className="group relative h-36 cursor-pointer md:h-44 overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:h-auto md:p-8">
              {/* Google Badge */}
              <div className="absolute right-3 top-3 text-gray-400">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
              ...
              <div ref={(el) => (scrollRefs.current[1] = el)} className="absolute inset-0 overflow-y-auto bg-white p-4 opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:p-8">
                <p className="text-xs md:text-base text-slate-700 leading-relaxed">
            ...
            {/* Review Card 3 */}
            <div onMouseEnter={() => handleMouseEnter(2)} className="group relative h-36 cursor-pointer md:h-44 overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:h-auto md:p-8">
              {/* Google Badge */}
              <div className="absolute right-3 top-3 text-gray-400">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
              ...
              <div ref={(el) => (scrollRefs.current[2] = el)} className="absolute inset-0 overflow-y-auto bg-white p-4 opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:p-8">
                <p className="text-xs md:text-base text-slate-700 leading-relaxed">
            ...
            {/* Review Card 4 */}
            <div onMouseEnter={() => handleMouseEnter(3)} className="group relative h-36 cursor-pointer md:h-44 overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:h-auto md:p-8">
              {/* Google Badge */}
              <div className="absolute right-3 top-3 text-gray-400">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
              ...
              <div ref={(el) => (scrollRefs.current[3] = el)} className="absolute inset-0 overflow-y-auto bg-white p-4 opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:p-8">
                <p className="text-xs md:text-base text-slate-700 leading-relaxed">
            ...
            {/* Review Card 5 */}
            <div onMouseEnter={() => handleMouseEnter(4)} className="group relative h-36 cursor-pointer md:h-44 overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:h-auto md:p-8">
              {/* Google Badge */}
              <div className="absolute right-3 top-3 text-gray-400">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
              ...
              <div ref={(el) => (scrollRefs.current[4] = el)} className="absolute inset-0 overflow-y-auto bg-white p-4 opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:p-8">
                <p className="text-xs md:text-base text-slate-700 leading-relaxed">
            ...
            {/* Review Card 6 */}
            <div onMouseEnter={() => handleMouseEnter(5)} className="group relative h-36 cursor-pointer md:h-44 overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:h-auto md:p-8">
              {/* Google Badge */}
              <div className="absolute right-3 top-3 text-gray-400">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
              ...
              <div ref={(el) => (scrollRefs.current[5] = el)} className="absolute inset-0 overflow-y-auto bg-white p-4 opacity-0 transition-opacity duration-300 md:group-hover:opacity-100 md:p-8">
                <p className="text-xs md:text-base text-slate-700 leading-relaxed">
