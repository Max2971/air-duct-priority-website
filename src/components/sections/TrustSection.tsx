...
export default function TrustSection({ variant = 'reviews', compact = false }: TrustSectionProps) {
  return (
              ...
              <>
                {variant === 'reviews' ? (
                  <a
                    ...
                    className="text-xl font-semibold text-slate-900 lg:text-2xl hover:text-blue-600 transition-colors"
                  >
                    500+ Google Reviews • Trusted by Bucks County Homeowners
                  </a>
                ) : (
                  <div className="flex flex-col items-center gap-4 lg:gap-6">
                    ...
                    <p className="text-xl font-semibold  lg:text-2xl text-[#F97316]">
                      Local Safety Expert
                    </p>
                  </div>
                )}
