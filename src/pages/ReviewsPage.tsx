...
export default function ReviewsPage() {
  return <div className="min-h-screen"><Header />
    <section className="bg-slate-900 py-20 text-center md:py-32"><div className="container mx-auto max-w-5xl px-6"><div className="mb-6 flex justify-center gap-2">{[1,2,3,4,5].map(n=><Star key={n} className="h-9 w-9 fill-yellow-400 text-yellow-400" />)}</div><h1 className="mb-6 text-4xl font-bold !text-white md:text-6xl">Air Duct Priority Reviews</h1><p className="mx-auto mb-8 max-w-3xl text-xl text-slate-200">Air Duct Priority has 544 verified Google reviews and a 5-star Google profile reported by the company as of June 2026.</p><a href="https://maps.app.goo.gl/c8kKh1yKKoHy9qNu6" target="_blank" rel="noopener noreferrer" className="inline-flex rounded-lg bg-blue-600 px-8 py-4 font-semibold text-white hover:bg-blue-700">Read Verified Google Reviews</a></div></section>
    ...
    <ProofSection />
    <section className="bg-slate-900 py-16 text-center"><div className="container mx-auto max-w-4xl px-6"><h2 className="mb-6 text-3xl font-bold !text-white">Talk Directly With Air Duct Priority</h2><a href="tel:+12157108781" className="inline-flex items-center gap-3 rounded-lg bg-blue-600 px-8 py-4 font-semibold text-white"><Phone className="h-5 w-5" />(215) 710-8781</a></div></section>
    <Footer /></div>;
}
